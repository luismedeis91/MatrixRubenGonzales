...
document.getElementById("forms").addEventListener("submit", function(event) {
    ...
    if (placaJaExiste(placa)) {
      ...
      N\xe3o \xe9 permitido estacionar dois autom\xf3veis com a mesma placa.<br>
      <em>"Parece que algu\xe9m quer arrumar problemas com a lei."</em><br>
      \u{2014} <strong>Perna Longa</strong>, <em>Looney Tunes</em>
    `;
...
document.getElementById("btn-retirar").onclick = ()=>{
    ...
    `;
        ...
        if (historicoList.firstChild) historicoList.insertBefore(historicoItem, historicoList.firstChild);
        else historicoList.appendChild(historicoItem);
...
//# sourceMappingURL=MatrixRubenGonzales.44983732.js.map
